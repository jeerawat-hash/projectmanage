...
{ 
        ...
        public function GetDataProjectsInfo($ProjectID)
        {
                ...
                $Project =  $this->pmdb->query(" SELECT *,(SELECT count(*) FROM ProjectPeriod WHERE ProjectID = ".$ProjectID.") as CoutPreiod,b.Name as CreateMemberName FROM Project a 
join Member b on a.CreateMemberID = b.ID WHERE a.ID = ".$ProjectID." ")->result();
